                  ...
                  children: securityPlanSchema ? (
                    <div>
                      ...
                      {activity?.status === "待补充备案材料" && securityPlan?.audit_status && securityPlan.audit_status !== "待编制" && (
                        <Alert type="info" showIcon title={isManager ? "待签署确认" : "已提交审核"}
                      ...
                      {isManager && securityPlan?.audit_status === "待签署" ? (
                        ...
                        const commitSigned = materials.some((m: any) => m.material_type === "filing_commitment" && m.sign_status === "signed");
                        return activity?.status !== "待安保方案设计" && !(activity?.status === "待补充备案材料" && !commitSigned);
                      })() ? (
                        <div>
                      ...
                      ) : isManager && securityPlan?.audit_status === "已签署" && (activity?.status === "待安保方案设计" || (activity?.status === "待补充备案材料" && !materials.some((m: any) => m.material_type === "filing_commitment" && m.sign_status === "signed"))) ? (
                        <>
                          <CommitmentSign
                            activityId={id!}
                            activityName={activity?.name || ""}
