    ...
    >
      ...
      {signatureUrl && (
        <div style={{ marginBottom: 16 }}>
          ...
          <br />
          <Image src={signatureUrl} alt="签名" style={{ maxWidth: 200, maxHeight: 80, borderRadius: 4, border: "1px solid #d9d9d9" }} />
        </div>
      )}

      <Space>
        <Button type="primary" onClick={handleSign} loading={signing || loading} disabled={!signatureUrl}>
          确认签署承诺书并提交备案
        </Button>
