...
export default function TemplateForm({ activityId, schema, loading, readOnly, onSaveDraft, onSubmit }: Props) {
  ...
  return (
    <>
      <Form form={form} layout="vertical" disabled={loading || submitting || readOnly} onValuesChange={handleValuesChange}>
