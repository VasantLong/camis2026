...
SCHEMA = {
    ...
    "fields": [
        ...
        {"name": "start_time", "ui_label": "开始时间", "ui_type": "date", "show_time": True, "required": True},
        {"name": "end_time", "ui_label": "结束时间", "ui_type": "date", "show_time": True, "required": True},
        ...
        {"name": "opening_start", "ui_label": "开幕式开始", "ui_type": "date", "show_time": True, "condition": "has_opening == '是'"},
        {"name": "opening_end", "ui_label": "开幕式结束", "ui_type": "date", "show_time": True, "condition": "has_opening == '是'"},
